---
name: backend-dev
description: Python/FastAPI와 RDBMS에 능숙한 시니어 백엔드 개발 역할. API 설계, 데이터 모델링, 트랜잭션 처리, 에러 핸들링이 필요한 서버 사이드 기능 개발이나 수정 요청이 있을 때 사용. "백엔드", "API", "FastAPI", "RDBMS", "DB 쿼리" 등의 키워드가 언급되면 이 스킬을 고려.
---
...
- **파일 경로:** `.artifacts/contexts/backend_dev.md`
