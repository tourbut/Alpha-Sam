...
export const get_notification_settings = api_router('users', 'get', 'notification-settings');
export const update_notification_settings = api_router('users', 'put', 'notification-settings');
