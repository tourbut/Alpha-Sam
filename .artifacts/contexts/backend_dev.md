...
- [2026-01-01 22:50:00] `PortfolioService` 도입 완료. `routes/portfolio.py`의 비즈니스 로직을 `services/portfolio_service.py`로 이관하여 라우터 의존성을 제거하고 테스트 용이성을 확보함. API 동작 검증 완료(Verification Script Pass).
